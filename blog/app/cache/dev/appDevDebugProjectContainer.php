...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'custommail' => 'getCustommailService',
    ...
    /**
     * Gets the 'custommail' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\CustomMailManager A AppBundle\Manager\CustomMailManager instance.
     */
    protected function getCustommailService()
    {
        return $this->services['custommail'] = new \AppBundle\Manager\CustomMailManager($this->get('doctrine.orm.default_entity_manager'), $this->get('twig'), $this->get('swiftmailer.mailer.default'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_71880bf94b6104839d38c890f55dab6b39aa30b50195be79b2256a2f44cc8dae');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '1ef3cf3fdd3881ef3d2ad27cc6c573b10');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1ef3cf3fdd3881ef3d2ad27cc6c573b10');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_password' => 'XXX',
            'locale' => 'en',
            'secret' => '1ef3cf3fdd3881ef3d2ad27cc6c573b10',
            'database_path' => NULL,
            ...
            'kernel.secret' => '1ef3cf3fdd3881ef3d2ad27cc6c573b10',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'XXX@gmail.com',
